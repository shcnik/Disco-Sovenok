...
init:
    define ds_fail_texts = {
        ...
        ''',
        'mi_rape': '''
        Сегодня в лагере «Совёнок» совершилось чудовищное преступление."
...
label ds_end_out_of_health:
    ...
    show screen ds_fail_game(10, ds_fail_texts['out_of_health'])
    $ ui.interact()
    return
...
label ds_end_out_of_morale:
    ...
    scene black with dissolve2
    play music ds_endgame
    show screen ds_fail_game(10, ds_fail_texts['out_of_morale'])
    $ ui.interact()
    return
...
label ds_end_bus_crash:
    ...
    show screen ds_fail_game(1, ds_fail_texts['bus_crash'])
    $ ui.interact()
    return
...
label ds_end_us_gone:
    ...
    show screen ds_fail_game(3, ds_fail_texts['us_gone'])
    $ ui.interact()
    return
...
label ds_end_mi_rape:
    ...
    show screen ds_fail_game(3, ds_fail_texts['mi_rape'])
    $ ui.interact()
    return
...
label ds_end_dv_rape:
    ...
    play music ds_endgame
    call ds_achievement('rape')
    show screen ds_fail_game(3, ds_fail_texts['dv_rape'])
    $ ui.interact()
    return
...
label ds_end_dv_rape2:
    ...
    play music ds_endgame
    call ds_achievement('rape')
    show screen ds_fail_game(3, ds_fail_texts['dv_rape2'])
    $ ui.interact()
    return
...
label ds_end_sl_rape:
    ...
    play music ds_endgame
    call ds_achievement('rape')
    show screen ds_fail_game(3, ds_fail_texts['sl_rape'])
    $ ui.interact()
    return
...
label ds_end_un_rape:
    ...
    play music ds_endgame
    call ds_achievement('rape')
    show screen ds_fail_game(3, ds_fail_texts['un_rape'])
    $ ui.interact()
    return
...
label ds_end_electrocution:
    ...
    show screen ds_fail_game(3, ds_fail_texts['electrocution'])
    $ ui.interact()
    return
