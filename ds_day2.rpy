        ...
        "Не будить":
            ...
            menu:
                "Почитать":
                    ...
                    window show
                    nvl clear
                    "После смерти вождя народов встал вопрос о назначении преемника. 5 марта 1953 года председателем Совета Министров СССР стал один из видных соратников великого Сталина, Георгий Максимилианович Маленков."
                    "В сложившейся после Великой Отечественной войны системе фактически обладатель именно этой должности считался преемником. Это обусловило избрание Маленкова на пост генерального секретаря ЦК КПСС 8 февраля 1955 года."
                    "С самого начала Маленков начал ослаблять наиболее чрезмерные ограничения: запрет на иностранную прессу, пересечение границ. Также прекратила преследоваться критика действий партии и правительства, остававшаяся в рамках социалистической идеологии."
                    "в 1956 году состоялся XX съезд КПСС. На нём были подвергнуты осуждению позиции ревизионистов во главе с Н.С. Хрущёвым. Сам Хрущёв был отправлен в отставку. По итогам съезда было признано, что несмотря на некоторые ошибки, политика Сталина была в целом правильной."
                    "Пост главы МВД сохранил Л.П. Берия. При нём была произведена частичная амнистия репрессированных из-за перегибов на местах. При этом, вопреки утверждениям империалистического Запада и антисоветчиков, было показано, что большинство репрессированных были осуждены не за «политические», а за общеуголовные статьи."
                    "На внешнеполитическом фронте удалось укрепить позиции социалистического лагеря. Венцом триумфа стало присоединение к СССР двух новых республик - Финляндии (1956) и Монголии (1954). Также следует отметить возвращение в социалистический лагерь отколовшейся ранее Югославии."
                    
                    nvl clear
                    "В 1959 году Анатолий Иванович Китов предложил создать общегосударственную автоматизированную систему управления народным хозяйством. Данная идея с подачи Генерального секретаря получила одобрение в партии, был создан Госкомупр - единый орган, координировавший разработку АСУ."
                    "С этого момента начинается история проекта ОГАС - Общегосударственной автоматизированной системы учёта и обработки информации. Однако, в полной мере её смогли развернуть при следующем Генеральном секретаре - Икари Генде (1967-1985)."
                    "Икари Генда родился в Японии в 1925 году. В ходе репрессий, осуществляемых японскими милитаристами в 1930-х годах, его семья эмигрировала в СССР. Генда принял коммунистические идеи, переданные ему родителями, и, получив гражданство СССР, тут же вступил в ВКП(б)."
                    ...
                    "Также была провозглашена политика партийного плюрализма: допускалось существование нескольких фракций со своими видениями дальнейшего пути развития СССР. Это позволило принимать наилучшие решения на основе дискуссии. Вкупе с этим был реализован проект ещё Сталина по альтернативным выборам в Верховный Совет из нескольких кандидатов."
                    "В это время усилия советской дипломатии позволили объединить два разобщённых империалистами народа - немцев и корейцев. ГДР и ФРГ объединились в единую Германию на условиях нейтралитета. То же произошло и с КНДР и Южной Кореей, образовавших Конфедерацию Корея. Оба государства стали членами СЭВ."
                    "Также И.Генда обратил внимание и на свою родину Японию. В 1977 году группа американских солдат совершила групповое изнасилование девочки. Данный инцидент был бы замят, если бы не вмешательство КГБ, предъявившего правду японскому обществу. Под давлением народных масс японское правительство разорвало все договоры с США и приняло политику нейтралитета."
                    "Фактически, это позволило начать сближение Японии и СССР в экономическом и культурном аспектах. Также за счёт разрыва отношений с США удалось достичь примирения Японии с одной стороны и Кореи и Китая с другой. И по сей день Япония остаётся одним из крупнейших партнёров СССР за пределами соцлагеря."

                    nvl clear
                    "В 1985 году И. Генду сменил Григорий Васильевич Романов. Новый Генеральный секретарь объявил о приверженности линии его предшественников по соединению жёсткой линии и реформ по дальнейшему внедрению ОГАС."
                    "Начало правления Романова отметилось двумя крупными космическими успехами СССР - запуском космической станции «Мир» в 1985 году и созданием первой лунной базы в 1986 году. Помимо этого, компьютеризация Советского Союза достигла таких высот, что стало возможным создание сети, объединяющей все ЭВМ и информацию на них - т.н. «интернета»."
                    "Также, в 1986 году была совершена бомбардировка лагерей моджахедов в Пакистане, что позволило вскоре завершить Афганскую войну победой правительственных сил, несмотря на осуждение западных стран. Афганистан стал одним из ближайших союзников СССР и по мере налаживания порядка - потенциальной новой союзной республикой."
                    "Одно можно сказать наверняка - с использованием последних достижений науки, особенно кибернетики, наступление светлой эры коммунизма уже не за горами. А усиливающиеся противоречия капитализма на фоне успехов социализма позволяют верить, что вскоре нас ждёт всемирный триумф идей марксизма-ленинизма."
                    window hide
